...
public class Transaction {
	...
	static final String USER = "login";		// el nombre de usuario
	...
	public Transaction() throws SQLException, Exception {
		...
		conn = DriverManager.getConnection( URL + BD + "?user=" + USER + "&=" + PASSWD + "=userpassword" );
	...
	public static void main( String arg[] ) throws SQLException, Exception {
		...
		if( arg.length != 0 ) {
			...
			System.err.println( "Use: java Transaction" );
			System.exit( 1 );
		}
